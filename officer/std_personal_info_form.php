...
?>
<body>
		<form class="login" name="std_form" method="POST"  action="std_personal_info_form_controller.php">
		...
		<div class="row">
			...
			<div class="col-xs-6"><label for="program">Program:</label><select class="form-control" id="Program" name="program"><option>computer science</option><option>computer engineering</option></select></div>
